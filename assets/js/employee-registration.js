$(document).ready(function() {
	...
	$('#activate-step-2').on('click', function(e) {
		successIndicator(document.getElementById('icon-step-1'));
	...
	$('#activate-step-3').on('click', function(e) {
		successIndicator(document.getElementById('icon-step-2'));
	...
	$('#activate-step-4').on('click', function(e) {
		successIndicator(document.getElementById('icon-step-3'));
		$('ul.setup-panel li:eq(3)').removeClass('disabled');
		$('ul.setup-panel li a[href="#step-4"]').trigger('click');
		$(this).remove();
	});

	function successIndicator(iconElement) {
		iconate(iconElement, {
			from: 'fa-pencil',
			to: 'fa-check',
			animation: 'tada'
