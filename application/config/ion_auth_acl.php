...
*/
$config['tables']['permissions']            = 'system_permissions';
$config['tables']['group_permissions']      = 'system_role_permissions';
$config['tables']['users_permissions']      = 'system_user_permissions';
 ...
 */
$config['join']['permissions']  = 'system_permission_id';
