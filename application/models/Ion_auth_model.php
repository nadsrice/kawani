...
class Ion_auth_model extends CI_Model
{
	...
	public function get_users_groups($id=FALSE)
	{
		...
		return $this->db->select($this->tables['users_groups'].'.'.$this->join['groups'].' as id, '.$this->tables['users_groups'].'.default_status, '.$this->tables['groups'].'.name, '.$this->tables['groups'].'.description')
