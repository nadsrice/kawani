...
class Admin extends CI_Controller
{
    ...
    public function add_permission()
    {
        ...
        $data['system_functions'] = $this->acl_model->get_system_functions();
        ...
        else
        {
            ...
            $function = $this->acl_model->get_system_functions(['s_function.id' => $function_id]);
            $module_id = $function[0]->smid;

            $new_permission_id = $this->ion_auth_acl->create_permission($this->input->post('perm_key'), $this->input->post('perm_name'), $module_id, $function_id);
    ...
    public function group_permissions()
    {
        ...
        $data['permissions']            =   $this->ion_auth_acl->permissions('full', 'method');
