    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <i class="fa fa-pencil-square-o"></i> <h3 class="box-title">Edit Shift Schedule</h3>
            </div>
            <div class="box-body">
                <form class="form-horizontal" action="<?php echo site_url('shift_schedules/edit/'.$shift_schedule['id']); ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input id="code" type="text" name="code" class="form-control" value="<?php echo $shift_schedule['code']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                <textarea name="description" class="form-control" rows="4" cols="30"><?php echo $shift_schedule['description']; ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select class="form-control select2 col-xs-3 col-md-3 col-sm-3 col-lg-3" name="type" id="type">
                                <option value="<?php echo $shift_schedule['type']; ?>"><?php echo $shift_schedule['type_label']; ?></option>
                                <option value="">-- Select Shift Schedule Type --</option>
                        ...
                        <div class="col-md-6">
                            <div class="bootstrap-timepicker">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="time_start" class="form-control pull-right timepicker" value="<?php echo $shift_schedule['time_start'] ?>">
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="bootstrap-timepicker">
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                    <input type="text" name="time_end" class="form-control pull-right timepicker" value="<?php echo $shift_schedule['time_end'] ?>">
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="grace_period" type="text" name="grace_period" class="form-control" value="<?php echo $shift_schedule['grace_period']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="no_of_hours" type="text" name="no_of_hours" class="form-control" value="<?php echo $shift_schedule['no_of_hours']; ?>">
