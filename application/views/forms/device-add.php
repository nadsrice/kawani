    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <i class="fa fa-pencil-square-o"></i> <h3 class="box-title">Add Device</h3>
            </div>
            <div class="box-body">
                <form class="form-horizontal" action="<?php echo site_url('devices/add'); ?>" method="post">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 text-left">IP Address</label>
                        <div class="col-md-6">
                            <input type="text" name="ip_address" class="form-control" value="<?php echo set_value('ip_address'); ?>">
                            <div class="validation_error"><?php echo form_error('ip_address'); ?></div>
                        </div>
                    </div>
                    <div class="form-group">
