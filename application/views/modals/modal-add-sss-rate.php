<form class="form-horizontal" action="<?php echo site_url('sss_contribution_rates/add'); ?>" method="post">
	...
	<div class="modal-footer">
		<input type="hidden" name="sss_matrix_id" value="<?php echo $sss_matrix_id; ?>">
