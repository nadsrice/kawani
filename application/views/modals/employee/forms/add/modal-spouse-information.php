<form class="form-horizontal" action="<?php echo site_url('employees/save/employee_spouse_information/'.$employee_id); ?>" method="post">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="birthdate" class="form-control" value="">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="block_number" class="form-control" value="">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="lot_number" class="form-control" value="">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="floor_number" class="form-control" value="">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="building_number" class="form-control" value="">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="building_name" class="form-control" value="">
