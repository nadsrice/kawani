<html>
    <body>
        ...
        <a href="<?php echo site_url('attendance_leaves/approve/'.$leave_data['id']); ?>">APPROVE</a> | <a href="<?php echo site_url('attendance_leaves/disapprove/'.$leave_data['id']); ?>">REJECT</a> <!-- | <a href="<?php echo site_url('attendance_leaves/disapprove/'.$leave_data['id']); ?>">CANCEL</a> --></p> 
    </body>
</html>
