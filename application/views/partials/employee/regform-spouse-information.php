<div class="panel box box-primary">
    <div class="box-header">
        <h4 class="box-title">
            <a href="#collapse-spouse-information" data-toggle="collapse" data-parent="#accordion-personal-background">Spouse Infomation</a>
        </h4>
    </div>
    <div class="panel-collapse collapse" id="collapse-spouse-information">
        <div class="box-body">
