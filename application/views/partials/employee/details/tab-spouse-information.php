<div class="tab-pane fade" id="tab-spouse-information">
    <div class="row">
        <div class="col-sm-12">
            ...
            <a href="<?php echo site_url('employees/add_spouse/'.$employee_id); ?>" class="btn btn-primary pull-right" data-toggle="modal" data-target="#modal-confirmation-spouse-information">
                <i class="fa fa-edit"></i> Add Spouse
            </a>
