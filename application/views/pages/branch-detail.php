        ...
        <div class="box box-primary">
            <div class="box-body">
                ...
                <p class="text-muted text-center">
                    <a href="<?php echo site_url('companies/details/' . $branch['company_id']); ?>">
                ...
                <a href="<?php echo site_url('branch/edit/' . $branch['id']); ?>" class="<?php echo $btn_edit; ?> btn-block">Edit Details</a>
            </div>
        </div>
    </div>
