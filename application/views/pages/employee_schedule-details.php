<div class="row">
    <div class="col-md-3">
        <div class="box box-primary">
            <div class="box-body">
                <h3 class="text-center"><?php echo $employee_schedule['name']; ?></h3>
                <p class="text-muted text-center">
                    <a href="<?php echo site_url('employee_schedules/details/' . $employee_schedule['name']); ?>">
                        <?php echo $employee_schedule['name']; ?>
                    </a>
                </p>
