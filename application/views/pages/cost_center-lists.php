                            ...
                            <?php foreach ($cost_centers as $cost_center): ?>
                                <tr>
                                    <td>
                                        ...
                                        <a class="<?php echo $btn_update; ?>" href="<?php echo site_url('cost_centers/edit_confirmation/' . $cost_center['id']); ?>" data-toggle="modal" data-target="#update-cost_center-<?php echo md5($cost_center['id']); ?>">
